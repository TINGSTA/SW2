...
#define _INTERVAL_DIST    19 // distance sensor interval (unit: ms)
#define _INTERVAL_SERVO   20 // servo interval (unit: ms)
#define _INTERVAL_SERIAL  19 // serial interval (unit: ms)
...
#define _SERVO_ANGLE_DIFF 110 // Replace with |D - E| degree
#define _SERVO_SPEED 120  // servo speed

#define _BANGBANG_RANGE  150  // duty up and down for bangbang control
...
float volt_to_distance(int a_value)
{
  ...
  int x = a_value;
  return (768 + -3.53*x + 5.79*0.001*x*x + -3.37*0.000001*x*x*x) ;
}
